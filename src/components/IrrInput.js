...
export default function IrrInput(props) {
   return(<><TextField autoComplete={"off"} type="number" sx={{ input: { color: "white" } }} id={props.id} value={props.value} onChange={props.onChange} label={props.label}  variant="filled" /><br/><br/></>
